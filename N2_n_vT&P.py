...
# load Hitran data from a file for the 14N2
# isotope of N2 which is 99.27 % of total
file = open('N2_data_2FEB2022.csv')
...
file2 = open('Partfun_N2_2FEB2022.txt')
...
E_eV_range=np.linspace(0.25,0.33,10000)
lambda_micron_range=1.2398/E_eV_range-1.2398/0.2894
...
Pgas = 40 # Pressure of gas in atm (1 atm = 1.01325)
...
alpha_HT=alphaHT(omega_range,Tgas,Pgas)
plt.plot(lambda_micron_range,alpha_HT)
plt.xlabel('Wavelength Relative to Line Center (micron)')
plt.ylabel('Absorption Coefficient ($cm^{-1})$')
plt.show()